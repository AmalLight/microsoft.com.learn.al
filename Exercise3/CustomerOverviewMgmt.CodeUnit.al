codeunit 50120 "Customer Overview Mgmt"
{
    ...
    begin
        ...
        if CustomerOverview.FindLast() then
            NextEntryNo := CustomerOverview."EntryNo" + 1
        else
            NextEntryNo := 1;
                ...
                if Customer.FindSet() then
                    repeat
                        ...
                        if GLEntry.FindSet() then begin
                            ...
                            CustomerOverview."EntryNo" := NextEntryNo;
                            CustomerOverview."CustomerNo" := Customer."No.";
                            CustomerOverview."CustomerName" := Customer.Name;
                            CustomerOverview."SourceCode" := SourceCode.Code;
